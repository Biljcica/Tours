...
type UpdateTourStatusRequest struct {
	...
	NewStatus     TourStatus             `protobuf:"varint,3,opt,name=newStatus,proto3,enum=TourStatus" json:"newStatus,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_tours_tours_service_proto_rawDesc = "" +
	"\n" +
	"\x19tours/tours-service.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x1a\n" +
	...
	"\vGetTourById\x12\x13.GetTourByIdRequest\x1a\r.TourResponse\x12G\n" +
	"\x10UpdateTourStatus\x12\x18.UpdateTourStatusRequest\x1a\x19.UpdateTourStatusResponse\x125\n" +
	...
	"\x0eDeleteKeyPoint\x12\x16.DeleteKeyPointRequest\x1a\x17.DeleteKeyPointResponse\x12J\n" +
	"\x11GetPublishedTours\x12\x19.GetPublishedToursRequest\x1a\x1a.GetPublishedToursResponse\x128\n" +
...
var file_tours_tours_service_proto_depIdxs = []int32{
	...
	11, // 18: ToursService.UpdateTourStatus:input_type -> UpdateTourStatusRequest
	14, // 19: ToursService.AddKeyPoint:input_type -> AddKeyPointRequest
	16, // 20: ToursService.UpdateKeyPoint:input_type -> UpdateKeyPointRequest
	17, // 21: ToursService.DeleteKeyPoint:input_type -> DeleteKeyPointRequest
	2,  // 22: ToursService.GetPublishedTours:input_type -> GetPublishedToursRequest
	19, // 23: ToursService.GetAllTours:input_type -> GetAllToursRequest
	...
	12, // 27: ToursService.UpdateTourStatus:output_type -> UpdateTourStatusResponse
	15, // 28: ToursService.AddKeyPoint:output_type -> KeyPointResponse
	15, // 29: ToursService.UpdateKeyPoint:output_type -> KeyPointResponse
	18, // 30: ToursService.DeleteKeyPoint:output_type -> DeleteKeyPointResponse
	3,  // 31: ToursService.GetPublishedTours:output_type -> GetPublishedToursResponse
	20, // 32: ToursService.GetAllTours:output_type -> GetAllToursResponse
