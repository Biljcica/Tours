...
const file_tours_tours_service_proto_rawDesc = "" +
	"\n" +
	"\x19tours/tours-service.proto\"\xc7\x01\n" +
	...
	"\bauthorId\x18\a \x01(\tR\bauthorId\"\xfb\x01\n" +
	...
	"\tkeyPoints\x18\t \x03(\v2\t.KeyPointR\tkeyPoints\"3\n" +
	...
	"\x05tours\x18\x01 \x03(\v2\r.TourResponseR\x05tours2\xa6\x03\n" +
	"\fToursService\x12/\n" +
	"\n" +
	"CreateTour\x12\x12.CreateTourRequest\x1a\r.TourResponse\x12A\n" +
	"\x0eGetAuthorTours\x12\x16.GetAuthorToursRequest\x1a\x17.GetAuthorToursResponse\x121\n" +
	"\vGetTourById\x12\x13.GetTourByIdRequest\x1a\r.TourResponse\x125\n" +
	"\vAddKeyPoint\x12\x13.AddKeyPointRequest\x1a\x11.KeyPointResponse\x12;\n" +
	"\x0eUpdateKeyPoint\x12\x16.UpdateKeyPointRequest\x1a\x11.KeyPointResponse\x12A\n" +
	"\x0eDeleteKeyPoint\x12\x16.DeleteKeyPointRequest\x1a\x17.DeleteKeyPointResponse\x128\n" +
	"\vGetAllTours\x12\x13.GetAllToursRequest\x1a\x14.GetAllToursResponseB\rZ\vproto/toursb\x06proto3"
...
var file_tours_tours_service_proto_depIdxs = []int32{
	...
	1,  // 4: GetAllToursResponse.tours:type_name -> TourResponse
	0,  // 5: ToursService.CreateTour:input_type -> CreateTourRequest
	...
	6,  // 8: ToursService.AddKeyPoint:input_type -> AddKeyPointRequest
	8,  // 9: ToursService.UpdateKeyPoint:input_type -> UpdateKeyPointRequest
	9,  // 10: ToursService.DeleteKeyPoint:input_type -> DeleteKeyPointRequest
	11, // 11: ToursService.GetAllTours:input_type -> GetAllToursRequest
	1,  // 12: ToursService.CreateTour:output_type -> TourResponse
	3,  // 13: ToursService.GetAuthorTours:output_type -> GetAuthorToursResponse
	1,  // 14: ToursService.GetTourById:output_type -> TourResponse
	7,  // 15: ToursService.AddKeyPoint:output_type -> KeyPointResponse
	7,  // 16: ToursService.UpdateKeyPoint:output_type -> KeyPointResponse
	10, // 17: ToursService.DeleteKeyPoint:output_type -> DeleteKeyPointResponse
	12, // 18: ToursService.GetAllTours:output_type -> GetAllToursResponse
