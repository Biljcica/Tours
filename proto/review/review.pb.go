...
type Review struct {
	...
	TouristImage  string                 `protobuf:"bytes,10,opt,name=tourist_image,json=touristImage,proto3" json:"tourist_image,omitempty"` // Dodato polje
...
type CreateReviewRequest struct {
	...
	TouristImage  string                 `protobuf:"bytes,8,opt,name=tourist_image,json=touristImage,proto3" json:"tourist_image,omitempty"` // Dodato polje
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UpdateReviewRequest struct {
	...
	TouristImage  string                 `protobuf:"bytes,7,opt,name=tourist_image,json=touristImage,proto3" json:"tourist_image,omitempty"` // Dodato polje
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_review_review_proto_rawDesc = "" +
	"\n" +
	"\x13review/review.proto\x12\x06review\x1a\x1fgoogle/protobuf/timestamp.proto\"\xdc\x02\n" +
	"\x06Review\x12\x0e\n" +
	...
	"\x0eaverage_rating\x18\x01 \x01(\x01R\raverageRating2\xa2\x04\n" +
	"\rReviewService\x12C\n" +
	"\fCreateReview\x12\x1b.review.CreateReviewRequest\x1a\x16.review.ReviewResponse\x12=\n" +
	"\tGetReview\x12\x18.review.GetReviewRequest\x1a\x16.review.ReviewResponse\x12O\n" +
	"\x10GetReviewsByTour\x12\x1f.review.GetReviewsByTourRequest\x1a\x1a.review.GetReviewsResponse\x12U\n" +
	"\x13GetReviewsByTourist\x12\".review.GetReviewsByTouristRequest\x1a\x1a.review.GetReviewsResponse\x12C\n" +
	"\fUpdateReview\x12\x1b.review.UpdateReviewRequest\x1a\x16.review.ReviewResponse\x12I\n" +
	"\fDeleteReview\x12\x1b.review.DeleteReviewRequest\x1a\x1c.review.DeleteReviewResponse\x12U\n" +
	"\x10GetAverageRating\x12\x1f.review.GetAverageRatingRequest\x1a .review.GetAverageRatingResponseB\x16Z\x14example/proto/reviewb\x06proto3"
